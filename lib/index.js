...
exports.code = util.format(multiline(function() {/*
  (function(draggable, droppable, dispatchTimeout) {
    %s;
    dnd.simulate(draggable, droppable, dispatchTimeout);
  })(arguments[0], arguments[1], arguments[2]);
*/}), coreCode);

exports.codeForSelectors = util.format(multiline(function() {/*
  (function(selectorDraggable, selectorDroppable, dispatchTimeout) {
    %s;
